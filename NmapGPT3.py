...
class NmapGPTGUI:
    def __init__(self, root):
        ...
        self.text_area_nmap.grid(row=5, column=0, sticky="nsew")
        ...
        self.reply_button_nmap.grid(row=6, column=0, pady=10)
        ...
        self.clear_button_nmap.grid(row=7, column=0, pady=10)
