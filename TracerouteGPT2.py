...
class TracerouteGPTGUI:
    def __init__(self, root):
        ...
        self.text_area_traceroute.grid(row=5, column=0, sticky="nsew")
        ...
        self.run_button_traceroute.grid(row=6, column=0, pady=10)
        ...
        self.clear_button_traceroute.grid(row=7, column=0, pady=10)
    ...
    def run_traceroute(self, event=None):
        ...
        try:
            ...
            traceroute_process = subprocess.Popen(['traceroute', ip_address], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
